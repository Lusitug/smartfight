...
# Access results
print("Distance:", alignment_plot.distance)
# Distance: 287.29683062447003
print("Normalized distance:", alignment_plot.normalizedDistance)
...
print("distance - dtai analise",distance)
# print(paths)
# print(best_path)
print("similarity_score - dtai analise",similarity_score)
